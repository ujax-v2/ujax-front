...
export const SolutionForm = () => {
    ...
    return (<div className="flex h-full flex-col bg-[#0F1117] text-slate-300">
      ...
      <div className="h-14 border-b border-slate-800 flex items-center justify-between px-4 bg-[#0F1117]">
        ...
        <Button className="bg-emerald-600 hover:bg-emerald-700 text-white" size="sm" onClick={handleRegister}>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-1/2 border-r border-slate-800 flex flex-col bg-[#1e1e1e]">
          ...
          <div className="flex-1 relative">
            <Editor height="100%" theme="vs-dark" language={language} value={code} options={{
        ...
        <div className="flex-1 flex flex-col bg-[#0F1117] overflow-y-auto">
          <div className="p-8 max-w-2xl mx-auto w-full space-y-6">
            <div className="space-y-2">
              ...
              <input type="text" placeholder="풀이의 핵심 내용을 요약해주세요" className="w-full h-12 bg-slate-900 border border-slate-800 rounded-lg px-4 text-slate-200 placeholder:text-slate-600 focus:outline-none focus:border-emerald-500 transition-colors"/>
            </div>

            <div className="space-y-2">
              <label className="text-sm font-semibold text-slate-300">설명</label>
              <textarea placeholder="접근 방식, 알고리즘, 시간 복잡도 등을 설명해주세요..." className="w-full h-64 bg-slate-900 border border-slate-800 rounded-lg p-4 text-slate-200 placeholder:text-slate-600 focus:outline-none focus:border-emerald-500 transition-colors resize-none leading-relaxed"/>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="p-3 bg-slate-900 border border-slate-800 rounded-lg flex flex-wrap gap-2 min-h-[50px]">
                ...
                <input type="text" placeholder="태그 입력..." className="bg-transparent border-none text-sm text-slate-300 focus:outline-none min-w-[100px]"/>
              </div>
            </div>
